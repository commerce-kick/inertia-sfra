...
const shippingSchema = z.object({
  ...
  dwfrm_shipping_shippingAddress_addressFields_firstName: z
    .string()
    .min(1, { message: "First name is required" }),
  dwfrm_shipping_shippingAddress_addressFields_lastName: z
    .string()
    .min(1, { message: "Last name is required" }),
  dwfrm_shipping_shippingAddress_addressFields_address1: z
    .string()
    .min(1, { message: "Address is required" }),
  dwfrm_shipping_shippingAddress_addressFields_address2: z.string().optional(),
  dwfrm_shipping_shippingAddress_addressFields_country: z
    .string()
    .min(1, { message: "Country is required" }),
  dwfrm_shipping_shippingAddress_addressFields_city: z
    .string()
    .min(1, { message: "City is required" }),
  dwfrm_shipping_shippingAddress_addressFields_postalCode: z
    .string()
    .min(1, { message: "Postal code is required" }),
  dwfrm_shipping_shippingAddress_addressFields_phone: z
    .string()
    .min(1, { message: "Phone number is required" }),
  dwfrm_shipping_shippingAddress_shippingMethodID: z
    .string()
    .min(1, { message: "Please select a shipping method" }),
});
  ...
  const form = useForm<z.infer<typeof shippingSchema>>({
    ...
    defaultValues: {
      ...
      dwfrm_shipping_shippingAddress_addressFields_country:
        model?.shippingAddress?.countryCode?.value || "US",
      ...
      dwfrm_shipping_shippingAddress_shippingMethodID:
        model?.selectedShippingMethod?.ID ||
  ...
  const updateMethod = useMutation({
    mutationFn: async (formData: z.infer<typeof shippingSchema>) => {
      const { data } = await axios.postForm(
        ...
        {
          firstName:
            formData.dwfrm_shipping_shippingAddress_addressFields_firstName,
          lastName:
            formData.dwfrm_shipping_shippingAddress_addressFields_lastName,
          address1:
            formData.dwfrm_shipping_shippingAddress_addressFields_address1,
          address2:
            formData.dwfrm_shipping_shippingAddress_addressFields_address2,
          city: formData.dwfrm_shipping_shippingAddress_addressFields_city,
          postalCode:
            formData.dwfrm_shipping_shippingAddress_addressFields_postalCode,
          countryCode:
            formData.dwfrm_shipping_shippingAddress_addressFields_country,
  ...
  useEffect(() => {
    if (addressMode === "saved" && savedAddresses.length > 0) {
      ...
      const selectedAddress =
        savedAddresses.find((addr) => addr.addressId === addressId) ||
        savedAddresses[0];
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-8">
                      ...
                      {shippingMethods.map((method) => (
                        ...
                        >
                          ...
                          >
                            ...
                            <p className="text-sm">
                              Estimated delivery: {method.estimatedArrivalTime}
                            </p>
                          </Label>
                        </div>
                      ))}
          ...
          <Button
            type="submit"
            className="w-full"
            disabled={submitShipping.isPending}
          >
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent className="sm:max-w-[500px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Make changes to your shipping address.
            </DialogDescription>
          </DialogHeader>
          <Form {...editForm}>
            <form
