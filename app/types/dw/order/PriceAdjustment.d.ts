...
import AmountDiscount = require('../campaign/AmountDiscount');
import PercentageDiscount = require('../campaign/PercentageDiscount');
import BonusChoiceDiscount = require('../campaign/BonusChoiceDiscount');
import FixedPriceDiscount = require('../campaign/FixedPriceDiscount');
import FreeDiscount = require('../campaign/FreeDiscount');
import FreeShippingDiscount = require('../campaign/FreeShippingDiscount');
import PercentageOptionDiscount = require('../campaign/PercentageOptionDiscount');
import PriceBookPriceDiscount = require('../campaign/PriceBookPriceDiscount');
import TotalFixedPriceDiscount = require('../campaign/TotalFixedPriceDiscount');
...
type Discounts = PercentageDiscount | AmountDiscount | BonusChoiceDiscount | FixedPriceDiscount | FreeDiscount | FreeShippingDiscount | PercentageOptionDiscount | PriceBookPriceDiscount | TotalFixedPriceDiscount
...
declare global {
	module ICustomAttributes {
		interface PriceAdjustment extends CustomAttributes {
		}
	}
}
...
If the AB-test, or this segment, has been removed from the system since this price adjustment was created, this method returns null. This method always returns null for custom price adjustments.
	...
	*/
	readonly appliedDiscount: Discounts | null
